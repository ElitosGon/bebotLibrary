...
module.exports = function(accessKey__, endPoint__){
    return {
        ...
        language: function(body__, headers__, parameters__, callback) {
            if (headers__ == null){ headers__ =  { 'Content-Type': 'application/json', 'Ocp-Apim-Subscription-Key': this.accessKey }}
            var options = { method: 'POST', uri: 'https://' + this.endPoint + this.pathLanguage, qs: parameters__, headers: headers__, body: body__, json: true};
            rp(options).then(function (parsedBody) {
                callback(null, parsedBody);
            }).catch(function (err) {
                callback(err, null);
        ...
        /* Object parameters to language function */
        languageParametersHelper: function(numberOfLanguagesToDetect__){
            return {
        ...
        keyPhrases: function(body__, headers__, callback) {
            if (headers__ == null){ headers__ =  { 'Content-Type': 'application/json', 'Ocp-Apim-Subscription-Key': this.accessKey }}
            var options = { method: 'POST', uri: 'https://' + this.endPoint + this.pathKeyPhrases, headers: headers__, body: body__, json: true};
            rp(options).then(function (parsedBody) {
                callback(null, parsedBody);
            }).catch(function (err) {
                callback(err, null);
