...
module.exports = function(accessKey__, endPoint__){
    return {
        ...
        /* Detect a text string language. */
        detect: function(headers__,parameters__, callback) {
            if (headers__ == null){ headers__ = {'Authorization': this.accessToken, 'Ocp-Apim-Subscription-Key': this.accessKey }}
            var options = { method: 'GET', uri: 'https://' + this.endPoint + this.pathDetect, qs: parameters__, headers: headers__};
            rp(options).then(function (parsedBody) {            
                callback(null, parsedBody);
            }).catch(function (err) {
                callback(err, null);
         ...
         /* Object headers to detect function */
        detectHeaderHelper: function(accessToken__, accessKey__){
            return {
                'Authorization': "Bearer " + accessToken__, 'Ocp-Apim-Subscription-Key': accessKey__,
            }
        },

        /* Object parameters to detect function */
        detectParametersHelper: function(appid__, text__){
            return {
                'appid': appid__,
                'text': text__
            }
        ...
        detectDescription: function(){
            return {
                "request": {
                    "path": "https://api.microsofttranslator.com/V2/Http.svc/Detect",
                    "method": "GET",
                    "headers": {
                        "type": "object",
                        "properties": {
